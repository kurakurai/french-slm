...
class TrainerBuilderBase(abc.ABC):
    ...
    def _configure_optimizer(self, training_args_kwargs: dict, trainer_kwargs: dict):
        def _configure_custom_optimizer(
            ...
            elif self.cfg.optimizer == "muon_clip":
                from muon import MuonClip, MuonConfig

                optimizer_kwargs["muon_config"] = MuonConfig()
                optimizer_kwargs["model"] = training_args_kwargs.get("model", None)
                optimizer_kwargs["model_config"] = training_args_kwargs.get("model_config", None)
                optimizer_cls = MuonClip
